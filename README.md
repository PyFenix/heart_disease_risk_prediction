...
- [Heart Disease Risk Prediction](#heart-disease-risk-prediction)
...
- [Installation](#installation)
    ...
    3. [Install Dependencies and Create Virtual Environment](#3-install-dependencies-and-create-virtual-environment)
- [Usage](#usage)
    - [Activate the Virtual Environment](#activate-the-virtual-environment)
    - [Run `make_dataset.py`](#run-make_datasetpy)
    - [Run the Main Pipeline](#run-the-main-pipeline)
    - [Explore the Notebooks](#explore-the-notebooks)
...
- [Running the API Locally](#running-the-api-locally)
    ...
    - [Steps to Run Locally](#steps-to-run-locally)
        ...
        3. [Navigate to the API Directory](#3-navigate-to-the-api-directory)
        4. [Run the API with Uvicorn](#4-run-the-api-with-uvicorn)
        5. [Access the API Documentation](#5-access-the-api-documentation)
        6. [Test the API](#6-test-the-api)
        7. [Running the API with Docker (Optional)](#7-running-the-api-with-docker-optional)
        8. [Stopping the API](#8-stopping-the-api)
- [Deploying the API with AWS CDK](#deploying-the-api-with-aws-cdk)
    - [Prerequisites](#prerequisites-2)
    - [Setup Instructions](#setup-instructions)
        1. [Configure AWS Credentials](#1-configure-aws-credentials)
        2. [Install CDK Dependencies](#2-install-cdk-dependencies)
        3. [Deploy the CDK Stack](#3-deploy-the-cdk-stack)
    - [Accessing the Deployed API](#accessing-the-deployed-api)
